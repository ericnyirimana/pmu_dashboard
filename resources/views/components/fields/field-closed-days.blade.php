        ...
        <div class="col-12">
          ...
          <div class="d-none">
              <div class="row date_box standard_closed_day_item" data-seq="0">
                  <div class="form-group box-days">
                          <input type="text" name="closings[0][name]" class="closing_name form-control" placeholder="Name" value="" />
                    </div>
                  <div class="form-group box-days">
                      <div class="input-group">
                          <input type="text"  name="closings[0][date]" class="closing_date form-control datepicker" placeholder="dd-mm-yyyy" value="" />
          ...
          @foreach($closedDays as $i=>$day)
                  <div class="row date_box @if($i==0) first_item @endif" data-seq="{{ $i }}">
                      ...
                      <div class="form-group box-days">
                              <input type="text" name="closings[{{ $i }}][name]" class="closing_name form-control" placeholder="Name" value="{{ $day['name'] }}" />
                        </div>

                      <div class="form-group box-days">
                          <div class="input-group">
                              <input type="text"  name="closings[{{ $i }}][date]" class="closing_date form-control datepicker" placeholder="dd-mm-yyyy" value="{{ $day['date'] }}" />
                              <div class="input-group-append">
                                  <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                              </div>
                          </div><!-- input-group -->
                      ...
                      <div class="form-group box-days">
                        <div class="checkbox">
                              <input id="checkbox{{ $i }}" type="checkbox" name="closings[{{ $i }}][repeat]" {{ $day['repeat'] ? 'checked' : '' }} class="closing_repeat">
